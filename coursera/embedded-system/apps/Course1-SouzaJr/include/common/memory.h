...
/**
 * @brief Set zero out all of the memory.
 *
 ...
 * @param length Data size
 *
 * @return Pointer to the changed source.
 */
 ...
 * @param length Data size
 *
 * @return Pointer to the reverted source.
 */
uint8_t *my_reverse(uint8_t *src, size_t length);

/**
 * @brief Should take number of words to allocate in dynamic memory
 *
...
/**
 * @brief Should free a dynamic memory allocation
 *
