...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        //             startIndexInclusive, (endIndexExclusive + startIndexInclusive)/2, input);
        //         ReciprocalArraySumTask right = new ReciprocalArraySumTask(
        //             (endIndexExclusive + startIndexInclusive)/2, endIndexExclusive, input);
        //         left.fork();
        //         right.compute();
        //         left.join();
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        Collection<ReciprocalArraySumTask> tasksOut = ForkJoinTask.invokeAll(tasks);
        for(ReciprocalArraySumTask task : tasksOut){
            sum += task.getValue();
        }
